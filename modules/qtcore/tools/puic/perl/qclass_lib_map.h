...
QT_CLASS_LIB(QtDebug4, QtCore, qdebug.h)
...
QT_CLASS_LIB(QtAlgorithms4, QtCore, qalgorithms.h)
...
QT_CLASS_LIB(QtContainerFwd4, QtCore, qcontainerfwd.h)
...
QT_CLASS_LIB(QVectorIterator, QtCore, qvector.h)
QT_CLASS_LIB(QMutableVectorIterator, QtCore, qvector.h)
QT_CLASS_LIB(QtEndian4, QtCore, qendian.h)
QT_CLASS_LIB(QtGlobal4, QtCore, qglobal.h)
...
QT_CLASS_LIB(QtMsgHandler4, QtCore, qglobal.h)
...
QT_CLASS_LIB(Qt4, QtCore, qnamespace.h)
...
QT_CLASS_LIB(QtCleanUpFunction4, QtCore, qcoreapplication.h)
...
QT_CLASS_LIB(QtConcurrentFilter4, QtCore, qtconcurrentfilter.h)
QT_CLASS_LIB(QtConcurrentMap4, QtCore, qtconcurrentmap.h)
QT_CLASS_LIB(QtConcurrentRun4, QtCore, qtconcurrentrun.h)
...
QT_CLASS_LIB(QtPlugin4, QtCore, qplugin.h)
QT_CLASS_LIB(QtPluginInstanceFunction4, QtCore, qplugin.h)
