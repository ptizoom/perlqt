...
int isDerivedFromByName(const char *className, const char *baseClassName, int count=0);
int isDerivedFrom(smokeperl_object *o, const char *baseClassName);
int isDerivedFrom(Smoke *smoke, Smoke::Index classId, Smoke *baseSmoke, Smoke::Index baseId, int count=0);
int isDerivedFrom(Smoke *smoke, const char *className, const char *baseClassName, int count=0);
